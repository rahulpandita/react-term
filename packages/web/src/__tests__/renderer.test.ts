...
describe('build256Palette', () => {
  ...
  it('first 16 entries match theme ANSI colors', () => {
    const themeColors = [
      ...
      DEFAULT_THEME.brightBlack, DEFAULT_THEME.brightRed, DEFAULT_THEME.brightGreen, DEFAULT_THEME.brightYellow,
      DEFAULT_THEME.brightBlue, DEFAULT_THEME.brightMagenta, DEFAULT_THEME.brightCyan, DEFAULT_THEME.brightWhite,
    ];
    for (let i = 0; i < 16; i++) {

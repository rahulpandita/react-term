...
describe('SkiaRenderer', () => {
  ...
  describe('empty grid', () => {
    it('produces only background rects and cursor for an empty grid', () => {
      ...
      const cursor: CursorState = { row: 0, col: 0, visible: false, style: 'block' };
  ...
  describe('colored cells', () => {
    ...
    it('uses correct background color for non-default bg', () => {
      ...
      const blueRect = rectCmds.find((c) =>
        c.color === DEFAULT_THEME.blue && c.width === renderer.getCellSize().width
      );
  ...
  describe('cursor', () => {
    it('renders block cursor with opacity', () => {
      ...
      const cursor: CursorState = { row: 1, col: 2, visible: true, style: 'block' };
    ...
    it('renders underline cursor', () => {
      const renderer = createRenderer();
      const grid = new CellGrid(5, 2);
      const cursor: CursorState = { row: 0, col: 0, visible: true, style: 'underline' };
    ...
    it('renders bar cursor', () => {
      const renderer = createRenderer();
      const grid = new CellGrid(5, 2);
      const cursor: CursorState = { row: 0, col: 0, visible: true, style: 'bar' };

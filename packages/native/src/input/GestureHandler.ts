/**
 * Touch gesture handling for the React Native terminal.
 *
 * This is a pure-logic handler with no React Native dependencies —
 * it translates gesture coordinates and states into terminal actions.
 */
